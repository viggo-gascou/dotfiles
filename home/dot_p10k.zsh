# Generated by Powerlevel10k configuration wizard on 2022-06-17 at 16:13 CEST.
...
() {
  ...
  # is empty.
  typeset -g POWERLEVEL9K_ANACONDA_CONTENT_EXPANSION='${${${${CONDA_PROMPT_MODIFIER#\(}% }%\)}:-${CONDA_DEFAULT_ENV:t}}'
